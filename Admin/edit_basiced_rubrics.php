    ...
    <div class="container mt-5">
       ...
       <thead class="table-dark">
            ...
            ?>
               ...
               <tr>
                    <td name="bseed">BSE / BSEED (or its equivalent)</td>
                    <td></td>
               ...
               <tr>
                    <td name="bsab">BS / AB + LET Passer 5 points</td>
                    <td></td>
               ...
               <tr>
                    <td class="bold-text" name="csexam">1.1.2 CS Exam (Professional) 2 points</td>
                    <td></td>
               ...
               <tr>
                    <td class="bold-text" name="adv_train">1.2.1 Advance Training</td>
                    <td></td>
