        ...
        <thead class="table-dark">
            ...
            <tbody>
                <tr>
                    ...
                    <td>40</td>
                    <td>160</td>
                    <td><input type="hidden" class="form-control input-field" name="educ_attain_sr"></td>
                ...
                <tr>
                    ...
                    <td>20</td>
                    <td><input type="hidden" class="form-control input-field" name="deg_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="deg_earned"></td>
                
                    
                </tr>
                <tr>
                    <td class="bold-text" name="bacc">1.1.1 Baccalaureate</td>
                    <td><input type="hidden" class="form-control input-field" name=""></td>
                    <td><input type="hidden" class="form-control input-field" name="bac_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="bacc"></td>
                ...
                <tr>
                    ...
                    <td></td>
                    <td><input type="hidden" class="form-control input-field" name="bse_cred_pts"></td>
                    <td><input type="text" class="form-control input-field" name="bse"></td>
                    
                <tr>
                    <td name="bs">BS / AB + LET Passer 5 points</td>
                    <td></td>
                    <td><input type="hidden" class="form-control input-field" name="bs_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="bs"></td>
                    
                </tr>
                <tr>
                    <td class="bold-text" name="cs_exam">1.1.2 CS Exam (Professional) 2 points</td>
                    <td></td>
                    <td><input type="hidden" class="form-control input-field" name="cs_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="cs_exam"></td>
                    
                </tr>
                <tr>
                    <td class="bold-text" name="prof_growth">1.2 Professional Growth (Maximum Points - 80)</td>
                    <td>20</td>
                    <td><input type="hidden" class="form-control input-field" name="prof_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="prof_growth"></td>
                    
                </tr>
                <tr>
                    <td class="bold-text" name="adv_training">1.2.1 Advance Training</td>
                    <td></td>
                    <td><input type="hidden" class="form-control input-field" name="adv_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="adv_training"></td>
                    
                </tr>
                <tr>
                    <td name="ma">MA / MS - 1pt /6 units</td>
                    <td></td>
                    <td><input type="hidden" class="form-control input-field" name="ma_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="ma"></td>
                    
                </tr>
                <tr>
                    <td name="ma_so">MA / MS - + SO 40 points</td>
                    <td></td>
                    <td><input type="hidden" class="form-control input-field" name="ms_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td> </td>
                    <td><input type="hidden" class="form-control input-field" name="seminar_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="seminars"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field" name=""></td>
                    <td><input type="hidden" class="form-control input-field" name="intnl_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="sem_intrntl"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field" name=""></td>
                    <td><input type="hidden" class="form-control input-field" name="natnl_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field" name=""></td>
                    <td><input type="hidden" class="form-control input-field" name="regnl_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="sem_rgnl"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field" name=""></td>
                    <td><input type="hidden" class="form-control input-field" name="local_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field"></td>
                    <td><input type="hidden" class="form-control input-field" name="trainr_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="trainer"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field"></td>
                    <td><input type="hidden" class="form-control input-field" name="rsrc_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field"></td>
                    <td><input type="hidden" class="form-control input-field" name="faci_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="faci"></td>
                    
                </tr>
                <tr>
                    <td class="bold-text" name="comp_cert">1.2.4 Completed Certificate of Proficiency (Maximum Points of 5 points)</td>
                    <td></td>
                    <td><input type="hidden" class="form-control input-field" name="cert_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="comp_cert"></td>
                ...
                <tr>
                    ...
                    <td>25</td>
                    <td>100</td>
                    <td><input type="hidden" class="form-control input-field" name="teach_exp"></td>
                    
                </tr>
                <tr>
                    <td name="stat_emp">2.1 Status of Employment (Maximum Points - 100)</td>
                    <td><input type="hidden" class="form-control input-field"></td>
                    <td><input type="hidden" class="form-control input-field" name="status_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field"></td>
                    <td><input type="hidden" class="form-control input-field" name="fulltime_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="fulltime"></td>
                    
                </tr>
                <tr>
                    <td name="parttime">2.1.2 Part Time (Based on Subject Loading for 1 school year)</td>
                    <td><input type="hidden" class="form-control input-field"></td>
                    <td><input type="hidden" class="form-control input-field" name="parttime_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field"></td>
                    <td><input type="hidden" class="form-control input-field" name="onesubs_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="onetotwo"></td>
                    
                </tr>
                <tr>
                    <td name="threetofour">3-4 subjects 2 pts/year</td>
                    <td><input type="hidden" class="form-control input-field"></td>
                    <td><input type="hidden" class="form-control input-field" name="threesubs_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field"></td>
                    <td><input type="hidden" class="form-control input-field" name="outside_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="outside"></td>
                ...
                <tr>
                    ...
                    <td>20</td>
                    <td>80</td>
                    <td><input type="hidden" class="form-control input-field" name="facult_perf"></td>
                    
                </tr>
                <tr>
                    <td name="mode">Mode for the last 3 year (Maximum Points - 80)</td>
                    <td>20</td>
                    <td><input type="hidden" class="form-control input-field" name="threeyrs_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="mode"></td>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>40</td>
                    <td><input type="hidden" class="form-control input-field" name="satisfy"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field" name=""></td>
                    <td><input type="hidden" class="form-control input-field" name="org_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="prof_org"></td>
                    
                </tr>
                <tr>
                    <td name="prof_intrntnl">International</td>
                    <td>5 pts/org</td>
                    <td><input type="hidden" class="form-control input-field" name="interntl_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td>4 pts/org</td>
                    <td><input type="hidden" class="form-control input-field" name="nationl_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="prof_ntnl"></td>
                    
                </tr>
                <tr>
                    <td name="prof_rgnl">Regional</td>
                    <td>3 pts/org</td>
                    <td><input type="hidden" class="form-control input-field" name="regionl_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td>1 pt/org</td>
                    <td><input type="hidden" class="form-control input-field" name="prvncl_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="prof_div"></td>
                ...
                <tr>
                    ...
                    <td>0.5 pts / event</td>
                    <td><input type="hidden" class="form-control input-field" name="coach_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td>5 pts / visit</td>
                    <td><input type="hidden" class="form-control input-field" name="area_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="area_chair"></td>
                    
                </tr>
                <tr>
                    <td name="comm_mem">Committee Member - PAASCU</td>
                    <td>2 pts / visit</td>
                    <td><input type="hidden" class="form-control input-field" name="comm_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field" name="chair_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field" name="other_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="chair_otherSch"></td>
                    
                </tr>
                <tr>
                    <td name="mem_acad">Membership in Academic (Co and Extra Curricular Ad. Hoc, RTC, etc)</td>
                    <td>2 pts / yr</td>
                    <td><input type="hidden" class="form-control input-field" name="memb_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="mem_acad"></td>
                ...
                <tr>
                    ...
                    <td>5 pts/ award</td>
                    <td><input type="hidden" class="form-control input-field" name="award_inter_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="awards_intrntnl"></td>
                    
                </tr>
                <tr>
                    <td name="awards_natnl">National</td>
                    <td>4 pts/ award</td>
                    <td><input type="hidden" class="form-control input-field" name="award_ntnl_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td>2 pts/ award</td>
                    <td><input type="hidden" class="form-control input-field" name="award_regnl_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="awards_rgnl"></td>
                    
                </tr>
                <tr>
                    <td name="awards_div">Division / Provincial </td>
                    <td>1 pt/ award</td>
                    <td><input type="hidden" class="form-control input-field" name="div_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td>5 pts</td>
                    <td><input type="hidden" class="form-control input-field" name="main_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="main_research"></td>
                    
                </tr>
                <tr>
                    <td name="co_research">Co-Researcher / Research or Statistic Consultant </td>
                    <td>3 pts</td>
                    <td><input type="hidden" class="form-control input-field" name="co_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td>1 pt</td>
                    <td><input type="hidden" class="form-control input-field" name="enum_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="enum"></td>
                    
                </tr>
                <tr>
                    <td name="research_lead">Research Leader </td>
                    <td>2 pt</td>
                    <td><input type="hidden" class="form-control input-field" name="lead_cred_pts"></td>
                ...
                : 5 - 20 points as recommended by the <br>Reviewing Committee </td>
                    <td><input type="hidden" class="form-control input-field"></td>
                    <td><input type="hidden" class="form-control input-field" name="report_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="research_out"></td>
                    
                </tr>
                <tr>
                    <td name="addtnl_five">Additional 5 points for the adoption of modules/kits </td>
                    <td><input type="hidden" class="form-control input-field"></td>
                    <td><input type="hidden" class="form-control input-field" name="add_cred_pts"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field"></td>
                    <td><input type="hidden" class="form-control input-field" name="pts_cred_pts"></td>
                    <td><input type="hidden" class="form-control input-field" name="pts"></td>
                ...
                <tr>
                    ...
                    <td><input type="hidden" class="form-control input-field" id="grand_percent" name="grand_percent"></td>
                    <td><input type="hidden" class="form-control input-field" id="grand_cred_pts" name="grand_cred_pts"></td>
